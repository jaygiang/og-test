...
function App() {
  return (
    <div className="App">
        ...
        <meta property="og:image" content="https://us-central1-grommet-designer.cloudfunctions.net/images/jay-giang-hpe-com/finisher_no_bg.jpg" data-react-helmet="true"/>
        ...
        <meta itemprop="image" content="https://us-central1-grommet-designer.cloudfunctions.net/images/jay-giang-hpe-com/finisher_no_bg.jpg" data-react-helmet="true"/>
        ...
        <meta name="twitter:image" content="https://us-central1-grommet-designer.cloudfunctions.net/images/jay-giang-hpe-com/finisher_no_bg.jpg" data-react-helmet="true"/>
      </Helmet>
